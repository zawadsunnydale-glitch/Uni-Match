  ...
  if (select && result && typeof BD_UNIVERSITIES !== "undefined"){
    ...
    function renderResources(){
      ...
      result.innerHTML = `
        ...
        <p style="font-size:.88rem;color:var(--cream-45);margin-top:14px;">Looking for something specific? Local preparation guides are contributed by current students on each campus track.</p>
      `;
    }
